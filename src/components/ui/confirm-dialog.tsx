  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="w-[480px] max-w-full bg-white rounded-[22px] shadow-pop overflow-hidden [animation:tzPop_.22s_ease_both]"
      >
        <div className="px-6 sm:px-7 pt-6 pb-5">
          <div className="font-display font-bold text-[11px] tracking-[.16em] uppercase text-brand-muted">{kicker}</div>
