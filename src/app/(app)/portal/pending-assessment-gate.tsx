...
export function PendingAssessmentGate({
  ...
  // El aviso vive en el layout del portal, que también envuelve al propio
  // formulario: sin esto, "Rellenar ahora" llevaría a una pantalla tapada por
  // el mismo aviso que acaba de pulsar.
  if (!open || pathname.startsWith(formPath)) return null;
      ...
      >
        ...
        <div className="px-7 py-6 flex flex-col gap-4">
          <p className="text-[14.5px] text-brand-text-2 leading-[1.6]">
            Te tocaba el <b>{dueDateLabel}</b>. Son unos minutos y es lo que permite a tu entrenador ver cómo has
            evolucionado de verdad, en vez de por sensación.
          </p>
          <Link
            href={formPath}
