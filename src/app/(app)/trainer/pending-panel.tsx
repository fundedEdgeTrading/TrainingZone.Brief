...
const TABS = [
  ...
  // E3-08: la pestaña "Feedback" (nueve deslizadores mensuales por socio) se
  // retira. Lo que dirección necesita sale del debrief de sesión, la asistencia
  // y el consumo de bono.
